...
<form action="{{route('passenger.update', $passengers->id)}}" method='post' enctype="multipart/form-data">
  @csrf
...
<div class="form-group">
    ...
    <input value="{{$passengers->contact_number}}" required type="tel"name="contact_number" class="form-control" id="number" aria-describedby="emailHelp" placeholder="Enter your contact number">
